...
{"ellheight",0,(void*)ellheight0,5,"GGD2,L,p","ellheight(e,x,{flag=2}): canonical height of point x on elliptic curve E defined by the vector e. flag is optional and selects the algorithm used"},
...
{"hilbert",0,(void*)hil0,4,"lGGDG","hilbert(x,y,{p}): Hilbert symbol at p of x,y. If x,y are integermods or p-adic, p can be omitted"},
