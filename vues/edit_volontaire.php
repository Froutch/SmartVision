<div class='add_partenaire'>
	...
	{
		echo"<input type='text' name='nom' placeholder='Nom' value=\"".$data['nom']."\" required>";
		echo"<input type='text' name='prenom' placeholder='Prénom' value=\"".$data['prenom']."\" required><br>";
	...
	while($data = mysql_fetch_array($result))
	{
		echo"<br><input type='text' name='mobile' placeholder='Téléphone Mobile' value=\"".$data['mobile']."\" required>";
