...
<?php
	...
	$query = 'SELECT volontaires.nom, volontaires.prenom, id_vol, partenaires.abreviation, missions.* FROM missions JOIN partenaires, volontaires WHERE id_partenaire = partenaires.id AND volontaires.id = missions.id_vol AND missions.prep_pret != "0000-00-00" AND missions.av_pret != "0000-00-00" AND missions.en_pret = "0000-00-00" AND annule = 0 ORDER BY missions.from';
