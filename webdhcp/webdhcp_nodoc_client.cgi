...
sub move_to_subnet {
#===============================
# This function moves a machine to a new subnet
#===============================
  my($query) = shift;
...
sub delfromdb {
#===============================
# This function looks for the host name
# entry and delete it.                             
#===============================  
  my ($ip,$hn) = @_;       
  my (@a,@rest,$addf, $l, $cfgfile);
...
#===============================
  ...
  while ($l = <DOC>) {
  	...
  	if ($#freelist < $limit){
		...
		&log("There are only $#freelist ip addresses available for the 192.168.$net.0 subnet!",'warning');
  		error("There are only a few ip addresses available for the 192.168.$net.0 subnet. Please contact the network administrator");
  	}else{
...
#	print $query->header(-cookie=>$mycookie);
	...
	print $query->header;
	print $query->start_html(-title=>'KSU - DHCP Configuration form',
                         -author=>'Michael Lewis',
                         -BGCOLOR=>'white');
	print "<h1>KSU - DHCP Configuration form</h1>\n";
	return;
}

sub footer {
#===============================
# This function prints the html footer
#===============================
my($query) = shift;
...
print <<F;
  <hr>
	...
	<a href=$cgiurl>DHCP Configuration Page</a> |
  	<a href="$networkhome">KSU Network Home</a><br>
	</center>
F
	return;
}
